...
Inline tests with [`roxygen2`](cran.r-project.org/package=roxygen2) using [`testthat`](cran.r-project.org/package=testthat) or [`tinytest`](cran.r-project.org/package=tinytest). 
